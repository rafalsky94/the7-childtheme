		...
		class Uncode_Lite_Welcome {
			...
			public function __construct() {
				...
				$this->tab_sections = array(
					...
					//'import_demo' => __('Import Demo', 'uncode-lite'),
			...
			public function uncodelite_activation_admin_notice() {
				...
				if( is_admin() && ('themes.php' == $pagenow) && (isset($_GET['activated'])) ) {
					...
					<div class="notice notice-success is-dismissible">
						<p><?php printf( __( 'Welcome! Thank you for choosing %1$s! Please make sure you visit our <a href="%2$s">Welcome page</a> to get started with %1$s.', 'uncode-lite' ), $this->theme_name, admin_url( 'themes.php?page=uncodelite-welcome' )  ); ?></p>
						<p><a class="button" href="<?php echo admin_url( 'themes.php?page=uncodelite-welcome' ) ?>"><?php _e( 'Lets Get Started', 'uncode-lite' ); ?></a></p>
					</div>
					<?php
				}
			}
			...
			public function uncodelite_welcome_screen() {
				...
				<div class="wrap about-wrap access-wrap">
					<h1><?php printf( esc_html__( 'Welcome to %s - Version %s', 'uncode-lite' ), $this->theme_name, $this->theme_version ); ?></h1>
					<div class="about-text"><?php printf( esc_html__( 'The %s is simple, minimal and clean WordPress Theme with elegant design. Though the Theme is simple, it does not lack any features. The theme is loaded with all features required to built a complete website with uncode.', 'uncode-lite' ), $this->theme_name ); ?></div>
				...
				<div class="nav-tab-wrapper clearfix">
					<?php foreach($tabs as $id => $label) : ?>
						...
						?>
						<a href="<?php echo admin_url('themes.php?page=uncodelite-welcome&section='.$id); ?>" class="<?php echo esc_attr($nav_class); ?>" >
			...
			public function uncodelite_plugin_installer_callback(){
				...
				if ( ! current_user_can('install_plugins') )
					wp_die( __( 'Sorry, you are not allowed to install plugins on this site.', 'uncode-lite' ) );
				...
				if (! wp_verify_nonce( $nonce, 'uncodelite_plugin_installer_nonce' ))
					wp_die( __( 'Error - unable to verify nonce, please try again.', 'uncode-lite') );
			...
			public function uncodelite_plugin_activation_callback(){
				...
				if ( ! current_user_can('install_plugins') )
					wp_die( __( 'Sorry, you are not allowed to activate plugins on this site.', 'uncode-lite' ) );
				...
				if (! wp_verify_nonce( $nonce, 'uncodelite_plugin_activate_nonce' ))
					die( __( 'Error - unable to verify nonce, please try again.', 'uncode-lite' ) );
